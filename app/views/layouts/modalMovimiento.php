    ...
    <div class="bg-white rounded-lg shadow-lg max-w-md w-full mx-4">
        ...
        <form method="POST" action="?route=borrarMovimiento">
            ...
            <div class="flex justify-between w-full pl-10 pr-10 pb-3.5">
                <a type="" class="md:block text-white p-2 cursor-pointer border border-solid bg-blue-600 rounded-2xl hover:bg-blue-700 duration-300" href="?route=movimientos">Cancelar</a>
