<nav class="flex bg-purple-900 text-white">
    <ul class="flex-col w-fit h-screen items-center m-5">
        <li class="border border-solid h-60 w-full text-center m-7"> LOGO </li>
